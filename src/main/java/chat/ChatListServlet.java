...
public class ChatListServlet extends HttpServlet {
	...
	public String getTen(String fromID, String toID) {
		...
		System.out.println("ChatListServlet - getTen - chatList.get().getChatID() : " + chatList.get(chatList.size()-1).getChatID());
	...
	public String getID(String fromID, String toID, String chatID) {
		...
		result.append("], \"last\":\"" + chatList.get(chatList.size()-1).getChatID() + "\"}");
		System.out.println("ChatListServlet - getID - chatList.get().getChatID() : " + chatList.get(chatList.size()-1).getChatID());
		return result.toString();
	}	
