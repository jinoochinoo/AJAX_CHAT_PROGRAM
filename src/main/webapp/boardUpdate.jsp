	...
	<div class="container">
		<form method="post" action="./boardUpdate" enctype="multipart/form-data">
			<table class="table table-bordered table-hover" style="text-align; center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="text-align: center;"><h4>게시물 수정 양식</h4></th>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" name="boardTitle" value="<%= board.getBoardTitle() %>"></td>
					</tr>					
					<tr>
						<td style="width: 120px; text-align: center;"><h5>내용</h5></td>
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048"><%= board.getBoardContent() %></textarea></td>
					</tr>					
					<tr>
					...
					<tr>
						<td style="text-align: left;" colspan="3"><input class="btn btn-primary pull-right" type="submit" value="게시글 수정">
					</tr>
				</tbody>
			</table>			
		</form>
